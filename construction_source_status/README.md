...
- 2026-07-22 OpenDART refresh attempt was blocked at API-key validation, so the previous OpenDART award/strategy caches were retained.
- Google News RSS: refreshed 2026-07-22, 365-day window, max 5 per company.
- Nara/G2B contracts: refreshed 2026-07-22 with a narrow 14-day query window because longer API windows can time out or exceed input limits.
