...
parser = argparse.ArgumentParser(description="Run resumable 2025 Google News RSS backfill partitions")
parser.add_argument("--db", default="data/market.db")
parser.add_argument("--config", default="campaigns/backfill-2025.json")
...
for category_code, base_query in categories.items():
    for start_date, end_date in windows:
        ...
        result = ingest_partition(
            ...
            job_code=f"BACKFILL_2025_GOOGLE_NEWS_RSS_{category_code}",
...
output = Path("artifacts/backfill-2025-google-news-rss-summary.json")
