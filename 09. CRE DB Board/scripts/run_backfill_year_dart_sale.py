...
parser = argparse.ArgumentParser(description="Run resumable year-range OpenDART sale disclosure backfill")
...
output = Path(f"artifacts/{campaign_slug}-opendart-sale-v2-summary.json")
output.parent.mkdir(parents=True, exist_ok=True)
output.write_text(json.dumps({"campaign": campaign_code, "partitions": summary}, ensure_ascii=False, indent=2), encoding="utf-8")
