-- V2.8.0: version-bound document content enrichment.
-- Stores generated summaries and bounded excerpts, never unrestricted publisher article bodies.

CREATE TABLE IF NOT EXISTS market_intelligence.document_enrichments (
...
ON market_intelligence.document_enrichments(document_version_id, status_code, review_status);

UPDATE market_intelligence.schema_meta
SET schema_value = '2.8.0'
