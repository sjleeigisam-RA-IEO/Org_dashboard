-- SQLite V3.3.0: governed, hierarchical, evidence-aware record classification.
BEGIN IMMEDIATE;

CREATE TEMP TABLE _v33_guard(value TEXT NOT NULL CHECK(value='3.2.0'));
INSERT INTO _v33_guard(value)
...
UPDATE schema_meta SET schema_value='3.3.0'
WHERE schema_key='schema_version' AND schema_value='3.2.0';
DROP TABLE _v33_guard;
COMMIT;
